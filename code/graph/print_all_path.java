...
public class print_all_path{
    ...
    public static void hasPath(ArrayList<Edge>[]graph, int src,int dest,boolean []visited,String psf){
        if(src == dest){
        ...
        for(Edge e:graph[src]){
            ...
            if(visited[nbr] == false){
                hasPath(graph, nbr, dest, visited, psf+nbr);
            }
        }
        visited[src] = false;
    }
